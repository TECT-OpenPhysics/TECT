...
<tr><td>11</td><td><strong>Cosmological constant</strong> $\Lambda$</td><td><span class="tag tag-ok">PROVED CONDITIONAL</span></td><td>Math58-v7 4-sector chain (monopole CP + measure-antisymmetry + vortex + BCC condensate + Dirac PV scheme); Math58-v7-AddA audit (Q1 dim-reg + Q2 alternate-regulator (UV-cutoff) scheme both DISMISSED)</td><td>Math58-v7-AddA Q5 numerical verification at Brazovskii operating point (Task #118)</td></tr>
</tbody>
</table>
